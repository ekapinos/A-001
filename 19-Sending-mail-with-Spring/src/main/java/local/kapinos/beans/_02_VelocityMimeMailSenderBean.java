...
@Component
public class _02_VelocityMimeMailSenderBean {
	...
	public void start() throws MessagingException, IOException  {
		logger.info("Velocity Mime Mail Sender start");
		...
		helper.setSubject("New Velocity Mime message from Spring " + LocalDateTime.now());
		...
		logger.info("Velocity Mime Mail Sender stop");
	}
}
